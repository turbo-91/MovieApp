...
class MovieAPIServiceTest {
    ...
    @Test
    void fetchMoviesBySearchQuery_ShouldReturnExistingMovies_WhenMoviesExistForQuery() {
        // GIVEN
        String searchQuery = "Inception";
        Movie movie = new Movie(
                "1", 101, "slug-inception", "Inception", "2010",
                "A mind-bending thriller", "Christopher Nolan", "Leonardo DiCaprio",
                "img1", "img2", "img3", List.of(searchQuery), List.of()
        );
    ...
    @Test
    void fetchMoviesBySearchQuery_ShouldThrowException_WhenQueryIsNullOrEmpty() {
        // GIVEN
        String emptyQuery = "";
